...
namespace Lazy.Vinke.Tests.Database.Oracle
{
    ...
    public class TestsLazyDatabaseOracleQueryPage : TestsLazyDatabaseQueryPage
    {
        ...
        public void QueryPage_Validations_DbmsDbType_Exception()
        {
            ...
            try { databaseOracle.QueryPage(sql, tableName, pageData, values, dbTypes, parameters); } catch (Exception exp) { exceptionConnection = exp; }

            databaseOracle.OpenConnection();

            try { databaseOracle.QueryPage(null, tableName, pageData, values, dbTypes, parameters); } catch (Exception exp) { exceptionSqlNull = exp; }
            try { databaseOracle.QueryPage(sql, null, pageData, values, dbTypes, parameters); } catch (Exception exp) { exceptionTableNameNull = exp; }
            try { databaseOracle.QueryPage(sql, tableName, pageDataNull, values, dbTypes, parameters); } catch (Exception exp) { exceptionPageDataNull = exp; }
            try { databaseOracle.QueryPage(sql, tableName, pageDataPageNumZero, values, dbTypes, parameters); } catch (Exception exp) { exceptionPageDataPageNumZero = exp; }
            try { databaseOracle.QueryPage(sql, tableName, pageDataPageSizeZero, values, dbTypes, parameters); } catch (Exception exp) { exceptionPageDataPageSizeZero = exp; }
            try { databaseOracle.QueryPage(sql, tableName, pageDataOrderByEmpty, values, dbTypes, parameters); } catch (Exception exp) { exceptionPageDataOrderByEmpty = exp; }
            try { databaseOracle.QueryPage(sql, tableName, pageData, values, null, null); } catch (Exception exp) { exceptionValuesButOthers = exp; }
            try { databaseOracle.QueryPage(sql, tableName, pageData, null, dbTypes, null); } catch (Exception exp) { exceptionDbTypesButOthers = exp; }
            try { databaseOracle.QueryPage(sql, tableName, pageData, null, null, parameters); } catch (Exception exp) { exceptionDbParametersButOthers = exp; }

            try { databaseOracle.QueryPage(sql, tableName, pageData, valuesLess, dbTypes, parameters); } catch (Exception exp) { exceptionValuesLessButOthers = exp; }
            try { databaseOracle.QueryPage(sql, tableName, pageData, values, dbTypesLess, parameters); } catch (Exception exp) { exceptionDbTypesLessButOthers = exp; }
            try { databaseOracle.QueryPage(sql, tableName, pageData, values, dbTypes, parametersLess); } catch (Exception exp) { exceptionDbParametersLessButOthers = exp; }
        ...
        public virtual void QueryPage_DataAdapterFill_DbmsDbTypeLowerPage_Success()
        {
            ...
            // Act
            pageData.PageNum = 1;
            LazyPageResult pageResult1 = databaseOracle.QueryPage(sql, tableName, pageData, new Object[] { 500, 600 }, new OracleDbType[] { OracleDbType.Int32, OracleDbType.Int32 }, new String[] { "LowId", "HighId" });
            pageData.PageNum = 2;
            LazyPageResult pageResult2 = databaseOracle.QueryPage(sql, tableName, pageData, new Object[] { 500, 600 }, new OracleDbType[] { OracleDbType.Int32, OracleDbType.Int32 }, new String[] { "LowId", "HighId" });
            pageData.PageNum = 3;
            LazyPageResult pageResult3 = databaseOracle.QueryPage(sql, tableName, pageData, new Object[] { 500, 600 }, new OracleDbType[] { OracleDbType.Int32, OracleDbType.Int32 }, new String[] { "LowId", "HighId" });
        ...
        public virtual void QueryPage_DataAdapterFill_DbmsDbTypeHigherPage_Success()
        {
            ...
            // Act
            pageData.PageNum = 1;
            LazyPageResult pageResult1 = databaseOracle.QueryPage(sql, tableName, pageData, new Object[] { 700, 800 }, new OracleDbType[] { OracleDbType.Int32, OracleDbType.Int32 }, new String[] { "LowId", "HighId" });
        ...
        public virtual void QueryPage_DataAdapterFill_DbmsDbTypeOutOfRange_Success()
        {
            ...
            // Act
            pageData.PageNum = 2;
            LazyPageResult pageResult = databaseOracle.QueryPage(sql, tableName, pageData, new Object[] { 3, 4 }, new OracleDbType[] { OracleDbType.Int32, OracleDbType.Int32 }, new String[] { "LowId", "HighId" });
    ...
    public class TestsLazyDatabaseOracleQueryPageObsolete : TestsLazyDatabaseQueryPageObsolete
    {
        [TestInitialize]
        public override void TestInitialize_OpenConnection_Single_Success()
        {
        ...
        public void QueryPage_Validations_DbmsDbType_Exception()
        {
            ...
            try { databaseOracle.QueryPage(sql, tableName, queryPageDataNull, values, dbTypes, parameters); } catch (Exception exp) { exceptionQueryPageDataNull = exp; }
        ...
        public virtual void QueryPage_DataAdapterFill_DbmsDbTypeLowerPage_Success()
        {
            ...
            LazyQueryPageResult queryPageResult1 = databaseOracle.QueryPage(sql, tableName, queryPageData, new Object[] { 500, 600 }, new OracleDbType[] { OracleDbType.Int32, OracleDbType.Int32 }, new String[] { "LowId", "HighId" });
            queryPageData.PageNum = 2;
            LazyQueryPageResult queryPageResult2 = databaseOracle.QueryPage(sql, tableName, queryPageData, new Object[] { 500, 600 }, new OracleDbType[] { OracleDbType.Int32, OracleDbType.Int32 }, new String[] { "LowId", "HighId" });
            queryPageData.PageNum = 3;
            LazyQueryPageResult queryPageResult3 = databaseOracle.QueryPage(sql, tableName, queryPageData, new Object[] { 500, 600 }, new OracleDbType[] { OracleDbType.Int32, OracleDbType.Int32 }, new String[] { "LowId", "HighId" });
        ...
        public virtual void QueryPage_DataAdapterFill_DbmsDbTypeHigherPage_Success()
        {
            ...
            // Act
            queryPageData.PageNum = 1;
            LazyQueryPageResult queryPageResult1 = databaseOracle.QueryPage(sql, tableName, queryPageData, new Object[] { 700, 800 }, new OracleDbType[] { OracleDbType.Int32, OracleDbType.Int32 }, new String[] { "LowId", "HighId" });
        ...
        public virtual void QueryPage_DataAdapterFill_DbmsDbTypeOutOfRange_Success()
        {
            ...
            // Act
            queryPageData.PageNum = 2;
            LazyQueryPageResult queryPageResult = databaseOracle.QueryPage(sql, tableName, queryPageData, new Object[] { 3, 4 }, new OracleDbType[] { OracleDbType.Int32, OracleDbType.Int32 }, new String[] { "LowId", "HighId" });
