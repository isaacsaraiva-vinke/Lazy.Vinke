...
namespace Lazy.Vinke.Tests.Database.Oracle
{
    ...
    public class TestsLazyDatabaseOracleSelect : TestsLazyDatabaseSelect
    {
        ...
        public virtual void Select_QueryTable_Arrays_Success()
        {
            ...
            OracleDbType[] dbTypes = new OracleDbType[] { OracleDbType.Int32, OracleDbType.Varchar2, OracleDbType.Decimal };
            ...
            databaseOracle.Execute(sqlInsert, valuesList[0], dbTypes, fields);
            databaseOracle.Execute(sqlInsert, valuesList[1], dbTypes, fields);
            databaseOracle.Execute(sqlInsert, valuesList[2], dbTypes, fields);

            // Act
            DataTable dataTable = databaseOracle.Select(tableName, valuesList[1], dbTypes, fields, returnFields: new String[] { "Amount" });
        ...
        public virtual void Select_QueryPage_Arrays_Success()
        {
            ...
            OracleDbType[] dbTypes = new OracleDbType[] { OracleDbType.Int32, OracleDbType.Int32, OracleDbType.Varchar2, OracleDbType.Decimal };
            List<Object[]> valuesList = new List<Object[]>() {
            ...
            databaseOracle.Execute(sqlInsert, valuesList[1], dbTypes, fields);
            databaseOracle.Execute(sqlInsert, valuesList[2], dbTypes, fields);
            databaseOracle.Execute(sqlInsert, valuesList[3], dbTypes, fields);
            databaseOracle.Execute(sqlInsert, valuesList[4], dbTypes, fields);

            fields = new String[] { "IdMaster" };
            dbTypes = new OracleDbType[] { OracleDbType.Int32 };
            ...
            // Act
            pageData.PageNum = 1;
            LazyPageResult pageResult1 = databaseOracle.Select(tableName, pageData, valuesList[0], dbTypes, fields, returnFields: new String[] { "IdMaster", "IdChild", "Amount" });
            pageData.PageNum = 2;
            LazyPageResult pageResult2 = databaseOracle.Select(tableName, pageData, valuesList[0], dbTypes, fields, returnFields: new String[] { "IdMaster", "IdChild", "Amount" });
