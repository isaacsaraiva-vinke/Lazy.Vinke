...
namespace Lazy.Vinke.Tests.Database.SqlServer
{
    ...
    public class TestsLazyDatabaseSqlServerUpsert : TestsLazyDatabaseUpsert
    {
        ...
        public virtual void Upsert_Arrays_Single_Success()
        {
            ...
            SqlDbType[] keyDbTypes = new SqlDbType[] { SqlDbType.VarChar, SqlDbType.Int };
            ...
            // Act
            rowsAffected += databaseSqlServer.Upsert(tableName, valuesList[0], dbTypes, fields, keyValuesList[0], keyDbTypes, keyFields);
            rowsAffected += databaseSqlServer.Upsert(tableName, valuesList[1], dbTypes, fields, keyValuesList[1], keyDbTypes, keyFields);
            rowsAffected += databaseSqlServer.Upsert(tableName, valuesList[2], dbTypes, fields, keyValuesList[2], keyDbTypes, keyFields);
