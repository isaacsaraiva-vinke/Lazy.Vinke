...
namespace Lazy.Vinke.Tests.Database.SqlServer
{
    ...
    public class TestsLazyDatabaseSqlServerQueryPage : TestsLazyDatabaseQueryPage
    {
        ...
        public void QueryPage_Validations_DbmsDbType_Exception()
        {
            ...
            try { databaseSqlServer.QueryPage(sql, tableName, pageData, values, dbTypes, parameters); } catch (Exception exp) { exceptionConnection = exp; }
            ...
            try { databaseSqlServer.QueryPage(sql, tableName, pageData, values, null, null); } catch (Exception exp) { exceptionValuesButOthers = exp; }
            try { databaseSqlServer.QueryPage(sql, tableName, pageData, null, dbTypes, null); } catch (Exception exp) { exceptionDbTypesButOthers = exp; }
            try { databaseSqlServer.QueryPage(sql, tableName, pageData, null, null, parameters); } catch (Exception exp) { exceptionDbParametersButOthers = exp; }

            try { databaseSqlServer.QueryPage(sql, tableName, pageData, valuesLess, dbTypes, parameters); } catch (Exception exp) { exceptionValuesLessButOthers = exp; }
            try { databaseSqlServer.QueryPage(sql, tableName, pageData, values, dbTypesLess, parameters); } catch (Exception exp) { exceptionDbTypesLessButOthers = exp; }
            try { databaseSqlServer.QueryPage(sql, tableName, pageData, values, dbTypes, parametersLess); } catch (Exception exp) { exceptionDbParametersLessButOthers = exp; }
        ...
        public virtual void QueryPage_DataAdapterFill_DbmsDbTypeLowerPage_Success()
        {
            ...
            // Act
            pageData.PageNum = 1;
            LazyPageResult pageResult1 = databaseSqlServer.QueryPage(sql, tableName, pageData, new Object[] { 500, 600 }, new SqlDbType[] { SqlDbType.Int, SqlDbType.Int }, new String[] { "LowId", "HighId" });
            pageData.PageNum = 2;
            LazyPageResult pageResult2 = databaseSqlServer.QueryPage(sql, tableName, pageData, new Object[] { 500, 600 }, new SqlDbType[] { SqlDbType.Int, SqlDbType.Int }, new String[] { "LowId", "HighId" });
            pageData.PageNum = 3;
            LazyPageResult pageResult3 = databaseSqlServer.QueryPage(sql, tableName, pageData, new Object[] { 500, 600 }, new SqlDbType[] { SqlDbType.Int, SqlDbType.Int }, new String[] { "LowId", "HighId" });
        ...
        public virtual void QueryPage_DataAdapterFill_DbmsDbTypeHigherPage_Success()
        {
            ...
            // Act
            pageData.PageNum = 1;
            LazyPageResult pageResult1 = databaseSqlServer.QueryPage(sql, tableName, pageData, new Object[] { 700, 800 }, new SqlDbType[] { SqlDbType.Int, SqlDbType.Int }, new String[] { "LowId", "HighId" });
        ...
        public virtual void QueryPage_DataAdapterFill_DbmsDbTypeOutOfRange_Success()
        {
            ...
            // Act
            pageData.PageNum = 2;
            LazyPageResult pageResult = databaseSqlServer.QueryPage(sql, tableName, pageData, new Object[] { 3, 4 }, new SqlDbType[] { SqlDbType.Int, SqlDbType.Int }, new String[] { "LowId", "HighId" });
    ...
    public class TestsLazyDatabaseSqlServerQueryPageObsolete : TestsLazyDatabaseQueryPageObsolete
    {
        [TestInitialize]
        public override void TestInitialize_OpenConnection_Single_Success()
        {
