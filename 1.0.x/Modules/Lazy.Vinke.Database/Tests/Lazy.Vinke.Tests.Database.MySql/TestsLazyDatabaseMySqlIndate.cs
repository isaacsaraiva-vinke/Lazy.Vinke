...
namespace Lazy.Vinke.Tests.Database.MySql
{
    ...
    public class TestsLazyDatabaseMySqlIndate : TestsLazyDatabaseIndate
    {
        ...
        public virtual void Indate_Arrays_Single_Success()
        {
            ...
            // Act
            rowsAffected += databaseMySql.Indate(tableName, valuesList[0], dbTypes, fields, keyFields);
            rowsAffected += databaseMySql.Indate(tableName, valuesList[1], dbTypes, fields, keyFields);
            rowsAffected += databaseMySql.Indate(tableName, valuesList[2], dbTypes, fields, keyFields);
