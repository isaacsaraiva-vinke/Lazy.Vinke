// TestsLazyDatabaseMySqlQueryPage.cs
//
...
{
    [TestClass]
    public class TestsLazyDatabaseMySqlQueryPage : TestsLazyDatabaseQueryPage
    {
        [TestInitialize]
        ...
        public void QueryPage_Validations_DbmsDbType_Exception()
        {
            ...
            try { databaseMySql.QueryPage(sql, tableName, pageData, values, dbTypes, parameters); } catch (Exception exp) { exceptionConnection = exp; }

            databaseMySql.OpenConnection();

            try { databaseMySql.QueryPage(null, tableName, pageData, values, dbTypes, parameters); } catch (Exception exp) { exceptionSqlNull = exp; }
            try { databaseMySql.QueryPage(sql, null, pageData, values, dbTypes, parameters); } catch (Exception exp) { exceptionTableNameNull = exp; }
            try { databaseMySql.QueryPage(sql, tableName, pageDataNull, values, dbTypes, parameters); } catch (Exception exp) { exceptionPageDataNull = exp; }
            try { databaseMySql.QueryPage(sql, tableName, pageDataPageNumZero, values, dbTypes, parameters); } catch (Exception exp) { exceptionPageDataPageNumZero = exp; }
            try { databaseMySql.QueryPage(sql, tableName, pageDataPageSizeZero, values, dbTypes, parameters); } catch (Exception exp) { exceptionPageDataPageSizeZero = exp; }
            try { databaseMySql.QueryPage(sql, tableName, pageDataOrderByEmpty, values, dbTypes, parameters); } catch (Exception exp) { exceptionPageDataOrderByEmpty = exp; }
            try { databaseMySql.QueryPage(sql, tableName, pageData, values, null, null); } catch (Exception exp) { exceptionValuesButOthers = exp; }
            try { databaseMySql.QueryPage(sql, tableName, pageData, null, dbTypes, null); } catch (Exception exp) { exceptionDbTypesButOthers = exp; }
            try { databaseMySql.QueryPage(sql, tableName, pageData, null, null, parameters); } catch (Exception exp) { exceptionDbParametersButOthers = exp; }

            try { databaseMySql.QueryPage(sql, tableName, pageData, valuesLess, dbTypes, parameters); } catch (Exception exp) { exceptionValuesLessButOthers = exp; }
            try { databaseMySql.QueryPage(sql, tableName, pageData, values, dbTypesLess, parameters); } catch (Exception exp) { exceptionDbTypesLessButOthers = exp; }
            try { databaseMySql.QueryPage(sql, tableName, pageData, values, dbTypes, parametersLess); } catch (Exception exp) { exceptionDbParametersLessButOthers = exp; }
        ...
        public virtual void QueryPage_DataAdapterFill_DbmsDbTypeLowerPage_Success()
        {
            ...
            // Act
            pageData.PageNum = 1;
            LazyPageResult pageResult1 = databaseMySql.QueryPage(sql, tableName, pageData, new Object[] { 500, 600 }, new MySqlDbType[] { MySqlDbType.Int32, MySqlDbType.Int32 }, new String[] { "LowId", "HighId" });
            pageData.PageNum = 2;
            LazyPageResult pageResult2 = databaseMySql.QueryPage(sql, tableName, pageData, new Object[] { 500, 600 }, new MySqlDbType[] { MySqlDbType.Int32, MySqlDbType.Int32 }, new String[] { "LowId", "HighId" });
            pageData.PageNum = 3;
            LazyPageResult pageResult3 = databaseMySql.QueryPage(sql, tableName, pageData, new Object[] { 500, 600 }, new MySqlDbType[] { MySqlDbType.Int32, MySqlDbType.Int32 }, new String[] { "LowId", "HighId" });
        ...
        public virtual void QueryPage_DataAdapterFill_DbmsDbTypeHigherPage_Success()
        {
            ...
            // Act
            pageData.PageNum = 1;
            LazyPageResult pageResult1 = databaseMySql.QueryPage(sql, tableName, pageData, new Object[] { 700, 800 }, new MySqlDbType[] { MySqlDbType.Int32, MySqlDbType.Int32 }, new String[] { "LowId", "HighId" });
        ...
        public virtual void QueryPage_DataAdapterFill_DbmsDbTypeOutOfRange_Success()
        {
            ...
            // Act
            pageData.PageNum = 2;
            LazyPageResult pageResult = databaseMySql.QueryPage(sql, tableName, pageData, new Object[] { 3, 4 }, new MySqlDbType[] { MySqlDbType.Int32, MySqlDbType.Int32 }, new String[] { "LowId", "HighId" });
    ...
    public class TestsLazyDatabaseMySqlQueryPageObsolete : TestsLazyDatabaseQueryPageObsolete
    {
        [TestInitialize]
        public override void TestInitialize_OpenConnection_Single_Success()
        {
        ...
        public void QueryPage_Validations_DbmsDbType_Exception()
        {
            ...
            try { databaseMySql.QueryPage(sql, tableName, queryPageDataNull, values, dbTypes, parameters); } catch (Exception exp) { exceptionQueryPageDataNull = exp; }
        ...
        public virtual void QueryPage_DataAdapterFill_DbmsDbTypeLowerPage_Success()
        {
            ...
            LazyQueryPageResult queryPageResult3 = databaseMySql.QueryPage(sql, tableName, queryPageData, new Object[] { 500, 600 }, new MySqlDbType[] { MySqlDbType.Int32, MySqlDbType.Int32 }, new String[] { "LowId", "HighId" });
