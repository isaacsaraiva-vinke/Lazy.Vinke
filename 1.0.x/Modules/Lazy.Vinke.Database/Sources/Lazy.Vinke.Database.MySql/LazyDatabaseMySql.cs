...
namespace Lazy.Vinke.Database.MySql
{
    public class LazyDatabaseMySql : LazyDatabase
    {
        ...
        /// <param name="dbTypes">The sql query parameters types</param>
        /// <returns>The records found</returns>
        public virtual LazyPageResult QueryPage(String sql, String tableName, LazyPageData pageData, Object[] values, MySqlDbType[] dbTypes)
        {
        ...
        /// <param name="parameters">The sql query parameters names</param>
        /// <returns>The records found</returns>
        public virtual LazyPageResult QueryPage(String sql, String tableName, LazyPageData pageData, Object[] values, MySqlDbType[] dbTypes, String[] parameters)
        {
            ...
            sql = String.Format("select count(*) over(), T.* from ({0}) T order by {1} limit {2} offset {3}", sql, pageData.OrderBy, pageData.PageSize, offset);
        ...
        public override Int32 Indate(String tableName, Object[] values, LazyDbType[] dbTypes, String[] fields, String[] keyFields)
        {
            ...
            Int32 recordsAffected = Execute(sql, values, dbTypes, fields);

            /* When an update happens MySql understand that was executed an delete operation folowed by an insert operation returning two records affected */
            return recordsAffected > 1 ? 1 : recordsAffected;
        }
        ...
        public virtual Int32 Upsert(String tableName, Object[] values, MySqlDbType[] dbTypes, String[] fields, Object[] keyValues, MySqlDbType[] keyDbTypes, String[] keyFields)
        {
            ...
            /* MySql does not have a merge statement to perform an update followed by an insert */
        ...
        /// <param name="dbTypes">The sql statement parameters types</param>
        /// <param name="parameters">The sql statement parameters names</param>
        protected virtual void ValidateParameters(String sql, Object[] values, MySqlDbType[] dbTypes, String[] parameters)
        {
            if (this.ConnectionState == ConnectionState.Closed)
                throw new Exception(LazyResourcesDatabase.LazyDatabaseExceptionConnectionNotOpen);
        ...
        /// <param name="dbTypes">The sql statement parameters types</param>
        /// <param name="parameters">The sql statement parameters names</param>
        protected virtual void ValidateParameters(String sql, String tableName, Object[] values, MySqlDbType[] dbTypes, String[] parameters)
        {
            if (this.ConnectionState == ConnectionState.Closed)
                throw new Exception(LazyResourcesDatabase.LazyDatabaseExceptionConnectionNotOpen);
        ...
        protected virtual void ValidateParameters(String sql, String tableName, LazyQueryPageData queryPageData, Object[] values, MySqlDbType[] dbTypes, String[] parameters)
        {
            if (this.ConnectionState == ConnectionState.Closed)
                throw new Exception(LazyResourcesDatabase.LazyDatabaseExceptionConnectionNotOpen);
        ...
        /// <param name="dbTypes">The sql statement parameters types</param>
        /// <param name="parameters">The sql statement parameters names</param>
        protected virtual void ValidateParameters(String sql, String tableName, LazyPageData pageData, Object[] values, MySqlDbType[] dbTypes, String[] parameters)
        {
            if (this.ConnectionState == ConnectionState.Closed)
                throw new Exception(LazyResourcesDatabase.LazyDatabaseExceptionConnectionNotOpen);
        ...
        protected override Int32 ConvertLazyDbTypeToDbmsType(LazyDbType dbType)
        {
            if (dbType != LazyDbType.DBNull)
            {
                ...
                if (dbType == LazyDbType.VarUByte) return (Int32)MySqlDbType.LongBlob;
            }
